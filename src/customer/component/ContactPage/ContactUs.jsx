    ...
    <>
      ...
      <div className="main grid place-items-center text-center py-8 px-4">
        ...
        <div className="max-w-7xl text-gray-200 space-y-4 mb-12">
          ...
          <p>
            আমরা হোয়াটসঅ্যাপ এ কোন প্রকার কল সাপোর্ট দেই না। অনুগ্রহ করে
            আমাদেরকে হোয়াটসঅ্যাপ এ কল করবেন না। শুধুমাত্র আমরা হোয়াটসঅ্যাপ এ
            এসএমএস সাপোর্ট দেই।
          </p>
        </div>
        ...
        {/* Support Section */}
        <div
          className="support grid grid-cols-12 gap-6 p-10 text-gray-200
        ...
        >
          ...
          <div className="col-span-12 md:col-span-5 flex flex-col justify-center gap-6">
            ...
            <p className="text-gray-300">
              Our support team is here 24/7 to help you with any issues or
              questions. Reach out anytime via chat, email, or phone.
            </p>
          </div>
