...
const Registration = () => {
  const FormData = UserStore((state) => state.FormData);
  ...
  return (
    <>
      <Helmet>
        <title>Registration | UniQbd</title>
        <meta
          name="description"
      ...
      <div className="main h-screen flex items-center justify-center px-4">
        <form
          ...
          className="bg-box backdrop-blur-md rounded-2xl w-full max-w-md md:max-w-lg lg:max-w-xl mx-auto p-6"
        >
          ...
          <div className="relative mt-10">
            <label className="block relative">
              <input
                ...
                type="text"
                name="name"
                className="peer p-3 rounded-md w-full bg-button outline-none focus:border-green text-gray-200"
              />
              <span
          ...
          <div className="text-center mt-8">
            <button
              type="submit"
              className="w-full py-2 rounded-lg bg-button text-white font-medium hover:bg-green/80 transition"
            >
              Register
            </button>
          </div>
