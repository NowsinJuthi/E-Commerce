...
const CheckOutPage = ({ cart, setCart }) => {
  ...
  return (
    <>
      ...
      <div
        className="main grid grid-cols-1 lg:grid-cols-12 
        ...
        <div className="left-side col-span-6 rounded-2xl bg-boxbg backdrop-blur-sm shadow-[0_-0.5px_20px_rgba(0.1,0,0,0.5)] p-5">
          ...
          <form className="space-y-5">
            ...
            <div className="relative">
              ...
              />
              <span
                className="absolute left-3 top-2 text-slate-400 transition-all peer-focus:text-green 
          ...
          <div className="space-y-6">
            {cart.length === 0 ? (
              ...
              <>
                ...
                <div className="mt-6">
                  <button
                    className="w-full cursor-pointer bg-box
