  ...
  return (
    <>
      ...
      <div className="p-6 min-h-screen">
        <h2 className="text-2xl font-bold text-white mb-6">Top Up</h2>
        <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6">
          {Topup.map((card, index) => (
            <div
              key={index}
              className="rounded-2xl shadow-lg hover:shadow-2xl transform bg-boxbg
